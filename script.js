...
// Form submission handling - opens Gmail with form data
...
if (contactForm) {
    contactForm.addEventListener('submit', (e) => {
        ...
        window.open(`https://mail.google.com/mail/?view=cm&fs=1&to=siddhpurakrisha27@gmail.com&su=${encodeURIComponent(subject)}&body=${emailBody}`, '_blank');
